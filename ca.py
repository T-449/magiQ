from lib.common import (
    load_config, sha256_hex, keys_dir, certs_dir,
    save_bytes, save_json, safe_name,
)
...
class CertificateAuthority:
    ...
    def init_keys(self):
        print("[CA] Generating ML-DSA-65 key pair ...")
    ...
    def register_provider(self, tls_cert, id_cert):
        """Store the provider's certificates so users can retrieve them."""
        self._provider_info = {"tls_cert": tls_cert, "id_cert": id_cert}
        print("[CA] Provider certs registered for distribution")
